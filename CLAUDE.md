...
- **当前阶段**：v23.2 — 项目上下文注入 + ``--cwd`` 启动。详见 [docs/decisions/v23.2.md](docs/decisions/v23.2.md)。
...
**下一档候选**：v15.2 prefill retry / v23.3 流式中继 + 父子 cancel token / v23.4 结构化结果 + 成本聚合 / v24 trajectory + insights。
...
#       v22_streaming, v23_0_delegate, v23_1_batch, v23_2_project_context
